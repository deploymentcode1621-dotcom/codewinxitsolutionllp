...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <div
          className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-blue-500 to-transparent opacity-60"
        ...
        <div className="max-w-7xl mx-auto px-6 h-full flex justify-between items-center relative">
          ...
          <a href="/" className="flex items-center gap-3 group relative z-10">
            ...
            {/* Glow Effect */}
            <div className="absolute inset-0 blur-2xl opacity-0 group-hover:opacity-40 transition-all duration-700 bg-gradient-to-r from-blue-500 to-purple-600" />

            {/* Logo Image */}
            <img
              src="/cwxlogo.png"
              alt="CodeWinX Logo"
              className={`relative h-14 md:h-16 w-auto object-contain transition-all duration-700 group-hover:rotate-[360deg] group-hover:scale-110 ${
        ...
        >
          ...
          <nav className="relative flex flex-col gap-2 p-6 mt-24">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="relative mt-6 flex items-center justify-center gap-3 px-6 py-4 rounded-2xl text-white font-semibold text-base overflow-hidden group"
            >
